...
public class ProviderSupport implements Entity<StringIdKey> {
    ...
    private static final long serialVersionUID = 7895815911717962757L;
    ...
    public ProviderSupport(StringIdKey key, String label, String description, String exampleParam) {
        this.key = key;
        this.label = label;
