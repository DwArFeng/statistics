...
public class EnabledProviderInfoCacheImpl implements EnabledProviderInfoCache {
    ...
    public void set(LongIdKey key, Collection<ProviderInfo> entities, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void leftPush(LongIdKey key, Collection<ProviderInfo> entities, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void rightPush(LongIdKey key, Collection<ProviderInfo> entities, long timeout) throws CacheException {
