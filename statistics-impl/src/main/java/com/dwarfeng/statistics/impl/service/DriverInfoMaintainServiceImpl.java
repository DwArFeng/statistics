...
public class DriverInfoMaintainServiceImpl implements DriverInfoMaintainService {
    ...
    private final BatchCrudService<LongIdKey, DriverInfo> crudService;
    private final EntireLookupService<DriverInfo> entireLookupService;
    private final PresetLookupService<DriverInfo> presetLookupService;

    public DriverInfoMaintainServiceImpl(
            BatchCrudService<LongIdKey, DriverInfo> crudService,
            EntireLookupService<DriverInfo> entireLookupService,
            PresetLookupService<DriverInfo> presetLookupService
    ) {
