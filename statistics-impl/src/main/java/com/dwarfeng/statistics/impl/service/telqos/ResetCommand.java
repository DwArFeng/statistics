...
public class ResetCommand extends CliCommand {
    ...
    private static final String COMMAND_OPTION_RESET_EXECUTE = "reset-execute";
    ...
    private String cliSyntaxProvider(CommandDescriptor.Context context) throws Exception {
        ...
        String[] patterns = new String[]{
                ...
                identity + " " + CliCommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_SUPERVISE),
                identity + " " + CliCommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_EXECUTE)
        };
    ...
    protected List<Option> provideOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_SUPERVISE).optionalArg(true).hasArg(false)
                .desc("执行重置主管功能操作").build());
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_EXECUTE).optionalArg(true).hasArg(false)
                .desc("执行重置执行功能操作").build());
        return list;
    }
    ...
    protected void executeWithCmd(CommandExecutor.Context context, CommandLine cmd) throws Exception {
        ...
        switch (pair.getLeft()) {
            ...
            case COMMAND_OPTION_RESET_SUPERVISE:
                ...
                break;
            case COMMAND_OPTION_RESET_EXECUTE:
                resetQosService.resetExecute();
                context.sendMessage("重置成功!");
                break;
            default:
