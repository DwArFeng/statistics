...
public class ResetCommand extends CliCommand {
    ...
    private static final String CMD_LINE_SYNTAX_RESET_EXECUTE = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_EXECUTE);
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_EXECUTE).desc("执行重置执行功能操作").build());
        return list;
    }
