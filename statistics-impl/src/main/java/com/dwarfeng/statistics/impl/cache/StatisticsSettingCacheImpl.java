...
import com.dwarfeng.statistics.stack.cache.StatisticsSettingCache;
...
@Repository
public class StatisticsSettingCacheImpl implements StatisticsSettingCache {

    private final RedisBatchBaseCache<LongIdKey, StatisticsSetting, FastJsonStatisticsSetting> batchBaseCache;

    public StatisticsSettingCacheImpl(RedisBatchBaseCache<LongIdKey, StatisticsSetting, FastJsonStatisticsSetting> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public StatisticsSetting get(LongIdKey key) throws CacheException {
    ...
    public void push(StatisticsSetting value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<StatisticsSetting> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<StatisticsSetting> entities, long timeout) throws CacheException {
