...
public class StatisticsSettingCacheImpl implements StatisticsSettingCache {
    ...
    private final BatchBaseCache<LongIdKey, StatisticsSetting> batchBaseCache;

    public StatisticsSettingCacheImpl(
            BatchBaseCache<LongIdKey, StatisticsSetting> batchBaseCache
    ) {
