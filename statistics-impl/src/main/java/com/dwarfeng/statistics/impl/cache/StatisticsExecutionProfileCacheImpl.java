...
public class StatisticsExecutionProfileCacheImpl implements StatisticsExecutionProfileCache {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public StatisticsExecutionProfile get(LongIdKey key) throws CacheException {
    ...
    public void push(StatisticsExecutionProfile value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<StatisticsExecutionProfile> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<StatisticsExecutionProfile> entities, long timeout) throws CacheException {
