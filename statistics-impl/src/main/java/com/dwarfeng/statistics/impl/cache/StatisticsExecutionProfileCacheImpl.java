...
public class StatisticsExecutionProfileCacheImpl implements StatisticsExecutionProfileCache {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<StatisticsExecutionProfile> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(List<StatisticsExecutionProfile> entities, long timeout) throws CacheException {
